...
![项目中心](docs/assets/homepage.png)

### 项目概览

进入项目后的总览页：基础信息、设定资产、章节进度一目了然。

![项目概览](docs/assets/overview.png)

### 剧情大纲

双栏交错时间线布局，按分卷组织剧情节点，支持拖拽排序与 AI 扩写。

![剧情大纲](docs/assets/story_line.png)

### 章节创作

三栏布局：目录树 + TipTap 富文本编辑器 + AI 侧边栏，写作与 AI 协作一屏完成。

![章节创作](docs/assets/chapter_creation.png)

### 封面工作台

面向各发布平台生成封面 Prompt 并调用图像模型出图，可对比历史版本。

![封面工作台](docs/assets/cover_design.png)
